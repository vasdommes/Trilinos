...
#else
  TEUCHOS_UNIT_TEST_TEMPLATE_2_DECL( CrsMatrix, EmptyTriSolve, Scalar, Node )
#endif
  {
#ifdef TPETRA_ENABLE_TEMPLATE_ORDINALS
...
#else
  TEUCHOS_UNIT_TEST_TEMPLATE_2_DECL( CrsMatrix, TriSolve, Scalar, Node )
#endif
  {
...
#define UNIT_TEST_GROUP( SCALAR, NODE ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_2_INSTANT( CrsMatrix, EmptyTriSolve, SCALAR, NODE ) \
  TEUCHOS_UNIT_TEST_TEMPLATE_2_INSTANT( CrsMatrix, TriSolve, SCALAR, NODE )
#endif
